"""
Version information for unctools.
...
Example: 0.2.0_main_1-20260101-a1b2c3d4
...
__version__ = "0.2.1_main_35-20260616-d782e3eb"
...
def get_pip_version():
    ...
    - Main branch: 0.2.0_main_3-20260404-hash -> 0.2.0
    - Dev branch: 0.2.0_dev_3-20260404-hash -> 0.2.0.dev3
    - Alpha: 0.2.0-alpha_main_3 -> 0.2.0a0
    """
    base = f"{MAJOR}.{MINOR}.{PATCH}"
